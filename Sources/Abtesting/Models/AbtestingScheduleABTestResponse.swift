...
public struct AbtestingScheduleABTestResponse: Codable, JSONEncodable {
...
extension AbtestingScheduleABTestResponse: Equatable {
    public static func ==(lhs: AbtestingScheduleABTestResponse, rhs: AbtestingScheduleABTestResponse) -> Bool {
        lhs.abTestScheduleID == rhs.abTestScheduleID
    }
}

extension AbtestingScheduleABTestResponse: Hashable {
